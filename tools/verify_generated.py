...
GENERATEURS = (
    ...
    "tools/gen_start_compatibility.py",
    "tools/build_event_pictures.py",
)
SORTIES = (
    ...
    "ad_astra/common/scripted_effects/zz_adastra_start_compatibility.txt",
    ...
    "ad_astra/interface/adastra_event_pictures.gfx",
)
