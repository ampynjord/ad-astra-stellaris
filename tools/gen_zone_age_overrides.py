...
from clausewitz import top_level_blocks
from vanilla_zone_age_map import ZONE_AGE
...
def main():
    ...
    output = [
        "# Ad Astra 1.3.2 - technologies des specialisations de district (zones).",
