...
CAPITAL_CHAIN = [
    dict(key="building_adastra_seat", icon="building_adastra_seat", age="stone", tech=None,
    ...
    dict(key="building_adastra_seat_bronze", icon="building_adastra_seat_bronze", age="bronze", tech="tech_adastra_language",
    ...
    dict(key="building_adastra_seat_iron", icon="building_adastra_seat_iron", age="iron", tech="tech_adastra_first_city",
         fr="Palais", en="Palace",
    ...
    dict(key="building_adastra_seat_medieval", icon="building_adastra_seat_medieval", age="medieval", tech="tech_adastra_law",
    ...
    dict(key="building_adastra_seat_renaissance", icon="building_adastra_seat_renaissance", age="renaissance", tech="tech_adastra_stone_architecture",
    ...
    dict(key="building_adastra_seat_steam", icon="building_adastra_seat_steam", age="steam", tech="tech_adastra_printing",
    ...
    dict(key="building_adastra_seat_industrial", icon="building_adastra_seat_industrial", age="industrial", tech="tech_adastra_steam_engine",
